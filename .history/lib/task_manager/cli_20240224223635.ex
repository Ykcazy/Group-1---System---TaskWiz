defmodule TaskManager.Cli do
  ...
  def view_all_tasks() do
    ...
    if Enum.empty?(tasks) do
      ...
      Enum.each(&display_task/1, tasks)
    end
  ...
  defp get_due_date() do
    ...
    due_date = get_input("") |> String.trim()
  ...
  @spec pick_edit(any()) :: :eof | :ok | binary() | char_list() | {:error, any()}
  ...
  @spec edit_task_field(:description | :due_date | :status | :title) ::
          :eof | binary() | char_list() | {:error, any()}
  ...
  @spec delete_task() :: :eof | binary() | char_list() | {:error, any()}
  def delete_task() do
    show_id()
